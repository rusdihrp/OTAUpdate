...
public:
    ...
    t_httpUpdate_return updates(const String& url, uint32_t size, const String& currentVersion = "");

    int getLastError(void);
    String getLastErrorString(void);

protected:
    t_httpUpdate_return handleUpdate(HTTPClient& http, uint32_t size, const String& currentVersion, bool spiffs = false);
